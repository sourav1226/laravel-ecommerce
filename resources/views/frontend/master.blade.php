...
<head>
    <meta charset="utf-8">
    <title>Multi Shop - @yield('title')</title>
        ...
        <div class="row bg-secondary py-1 px-xl-5">
            <div class="col-lg-6 d-none d-lg-block">
                <div class="d-inline-flex align-items-center h-100">
                    <a href="{{ url('/contact') }}" class="text-body mr-3" href="">Contact</a>
                </div>
            </div>
                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <a href="{{ url('/shop-details') }}" class="nav-item nav-link {{ request()->is('shop-details') ? 'active' : '' }}">Shop Detail</a>
    ...
    <div class="container-fluid bg-dark text-secondary mt-5 pt-5">
        ...
        <div class="row border-top mx-xl-5 py-4" style="border-color: rgba(256, 256, 256, .1) !important;">
            ...
            <div class="col-md-6 px-xl-0 text-center text-md-right">
                <img class="img-fluid" src="{{ asset('assets/frontend/img/payments.png') }}" alt="">
            </div>
        </div>
    </div>
    <!-- Footer End -->
